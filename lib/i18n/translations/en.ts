...
export const en: Translations = {
  ...
  whyChooseUs: {
    ...
    benefits: {
      ...
      security: {
        title: 'DevSecOps Integration',
        description: 'Automate security testing, manage compliance as code',
        stat: 'Automated',
      },
      fasterDeploy: {
        title: 'Self-Service Platform',
        description: 'Enable developers to deploy without waiting for infrastructure',
        stat: 'Self-Service',
      },
      support: {
        title: 'AI-Driven Monitoring',
        description: 'Detect issues proactively with AIOps, auto-remediation',
        stat: 'Proactive',
      },
      provenSuccess: {
    ...
    trustBar: {
      awsPartner: {
        badge: '🚀 GitOps',
        description: 'Continuous deployment with ArgoCD and Flux',
      },
      iso: {
      ...
      kvkk: {
        badge: '🤖 AI-Driven',
        description: 'LLMOps, AgentOps, and AI workflows',
      },
    },
  },
  servicesCta: {
