...
export const de: Translations = {
  ...
  hero: {
    ...
    subtitle: '40% schnellere Deployments, 65% weniger Infrastruktur-Vorfälle. Self-Service-Entwicklerplattformen mit GitOps und Platform Engineering auf AWS, Azure, GCP. Automatisierung von AI-Workflows, LLMOps und CI/CD-Systemen.',
  ...
  services: {
    ...
    subtitle: 'Umfassende DevOps-Lösungen für Unternehmen jeder Größe',
    tiers: {
      foundation: {
        title: 'Basis-Services',
        description: 'Beginnen Sie Ihre DevOps-Reise',
      },
      transformation: {
        title: 'Transformations-Services',
        description: 'Modernisieren Sie Ihre Infrastruktur',
      },
      advanced: {
        title: 'Erweitert',
  ...
  whyChooseUs: {
    ...
    subtitle: 'Beschleunigen Sie Deployments und reduzieren Sie Kosten mit Platform Engineering und GitOps',
    benefits: {
      fastResult: {
        title: '40% Schnellere Deployments',
        description: 'Code schneller in Produktion mit GitOps und automatisiertem CI/CD',
        stat: '40%',
      },
      costOptimization: {
        title: '65% Weniger Vorfälle',
        description: 'Minimieren Sie Infrastrukturfehler mit Platform Engineering und IaC',
        stat: '65%',
      },
      security: {
        title: 'DevSecOps-Integration',
        description: 'Automatisieren Sie Sicherheitstests, verwalten Sie Compliance als Code',
        stat: 'Automatisch',
      },
      fasterDeploy: {
        title: 'Self-Service-Plattform',
        description: 'Entwickler können deployen ohne auf Infrastruktur zu warten',
        stat: 'Self-Service',
      },
      support: {
        title: 'AI-Driven Monitoring',
        description: 'Erkennen Sie Probleme proaktiv mit AIOps, Auto-Remediation',
        stat: 'Proaktiv',
      },
      provenSuccess: {
    ...
    trustBar: {
      awsPartner: {
        badge: '🚀 GitOps',
        description: 'Continuous Deployment mit ArgoCD und Flux',
      },
      iso: {
        badge: '🏗️ Platform Engineering',
        description: 'Internal Developer Platform (IDP) Setup',
      },
      kvkk: {
        badge: '🤖 AI-Driven',
        description: 'LLMOps, AgentOps und AI-Workflows',
      },
    },
  },
  servicesCta: {
  ...
  footer: {
    tagline: 'Türkeis DevOps-Transformationspartner',
    services: 'Dienstleistungen',
    company: 'Unternehmen',
    legal: 'Rechtliches',
